...
var useValidators = function useValidators(_ref) {
  ...
  var onFilesSelected = react.useCallback(function (data) {
  ...
  var onFilesSuccessfullySelected = react.useCallback(function (data) {
  ...
  var onFilesRejected = react.useCallback(function (errors) {
...
function useFilePicker(props) {
  ...
  var parseFile = react.useCallback(function (file) {
  ...
  var openFilePicker = react.useCallback(function () {
